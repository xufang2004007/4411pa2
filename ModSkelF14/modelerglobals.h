...
enum SampleModelControls { 
	...
	GIRL_METABALL_SKIN, METABALL_SURFACE_THRESHOLD, METABALL_BODY_BALL_RADIUS, METABALL_BODY_BALL_SPACING, METABALL_ARM_BALL_RADIUS, METABALL_ARM_BALL_SPACING, NUM_MARCHING_CUBES,
